...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Reus', 'cat', '1', 'images/CAT_Reus.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_update_pet_info(name='red', animal_type='red', age='5'):
...
def test_add_pets_with_valid_data_without_photo(name='Reus_without_photo', animal_type='cat', age='1'):
...
def test_add_photo_at_pet(pet_photo='images/CAT_Reus.jpg'):
...
def test_add_pet_negative_age_number(name='Martin', animal_type='cat', age='-5', pet_photo='images/CAT_Martin.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Martin', animal_type='cat', age='1932', pet_photo='images/CAT_Martin.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='5', pet_photo='images/CAT_Martin.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='5', pet_photo='images/CAT_Martin.jpg'):
    ...
    name = 'Martin Martin Martin Martin Martin Martin Martin Martin Martin Martin Martin Martin'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Martin', age='5', pet_photo='images/Cat_Martin.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Martin', animal_type='1932', age='5',
                                                      pet_photo='CAT_Martin.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Martin', age='5', pet_photo='images/CAT_Martin.jpg'):
    ...
    animal_type = 'Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat Scotland_Cat'
